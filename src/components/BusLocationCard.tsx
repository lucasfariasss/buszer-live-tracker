...
const BusLocationCard = ({ latitude, longitude, busName, lastUpdate }: BusLocationCardProps) => {
  return (
    <Card className="absolute top-6 left-1/2 -translate-x-1/2 z-[1000] w-[90%] max-w-md bg-gradient-to-b from-card to-card/95 backdrop-blur-sm border-primary/20 shadow-[var(--shadow-card)]">
      <div className="p-6">
